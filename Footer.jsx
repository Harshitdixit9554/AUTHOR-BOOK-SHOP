  ...
  return (
    <>
      <footer className="text-slate-400">
        ...
        <div className="pt-4 pb-4 text-lg border-t border-slate-900 bg-slate-800">
          <div className="container px-4 mx-auto">
            <div className="grid grid-cols-4 gap-4 md:grid-cols-6 lg:grid-cols-12">
              <nav className="col-span-4 md:col-span-4 lg:col-span-3" aria-labelledby="footer-product-dark">
                <h3 className="mb-6 text-base font-medium text-white" id="footer-product-dark">Product</h3>
                <ul>
                  <li className="mb-6 leading-6">
